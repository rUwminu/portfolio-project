...
import img1 from "@/app/(portfolio)/_assets/projects/syplt-site-1.png";
import img2 from "@/app/(portfolio)/_assets/projects/syplt-site-2.png";
import img3 from "@/app/(portfolio)/_assets/projects/syplt-site-3.png";

const Page = () => {
  const project = {
    name: "Syplt",
    year: "2026",
    tools: ["React.Js", "Next.Js", "UI", "UX", "Tailwind css", "Gsap", "Video"],
    summary:
