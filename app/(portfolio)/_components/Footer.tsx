...
const Footer = () => {
  return (
    <section className="flex flex-col xl:flex-row xl:items-center gap-4 w-full pt-6 pb-30 md:pb-36 md:pt-8 px-0 md:px-8">
      <div className="flex items-center gap-4">
        ...
        <Link
          ...
          className="shrink-0  flex items-center justify-center w-[clamp(56px,3.5vw,104px)] h-[clamp(56px,3.5vw,104px)] aspect-square p-3 md:p-[1vw] bg-white rounded-full"
          style={{
